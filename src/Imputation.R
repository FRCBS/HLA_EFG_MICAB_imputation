...
# load models
model_MICA <- hlaModelFromObj(get(load('models/VI/MICA.RData')))
model_MICB <- hlaModelFromObj(get(load('models/VI/MICB.RData')))
model_HLA_E <- hlaModelFromObj(get(load('models/VI/HLA_E.RData')))
model_HLA_F <- hlaModelFromObj(get(load('models/VI/HLA_F.RData')))
model_HLA_G <- hlaModelFromObj(get(load('models/I/HLA_G.RData')))
model_HLA_G_3UTR <- hlaModelFromObj(get(load('models/I/HLA_G_3UTR.RData')))
model_HLA_G_5UTR <- hlaModelFromObj(get(load('models/I/HLA_G_5UTR.RData')))
